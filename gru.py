...
from keras.layers import Dense, Flatten, BatchNormalization, GRU
...
model = Sequential() 
model.add(GRU(units=60, return_sequences=True, input_shape=inputShape)) 
...
f = open("gru_results2.txt", "w")
f.write(outputString)
f.write("Average General RMAE: " + str(get_mean(generalRMSE)) + "\n")
f.write("Average Train RMAE: " + str(get_mean(trainRMSE)) + "\n")
